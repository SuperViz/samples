<template>
  <section>
    <button @click="initWhoIsOnline">
        Enter Who-is-Online as {{ participantName }}
      </button>
    <div :id="containerId" />
  </section>
</template>
...
<script>
  ...
  const groupId = "sv-sample-room-vue-js-who-is-online";
  const groupName = "Sample Room for Who Is Online (Vue/JS)";
